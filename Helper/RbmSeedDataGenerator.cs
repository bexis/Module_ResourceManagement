    ...
    public class RbmSeedDataGenerator : IDisposable
    {
        ...
        public void GenerateSeedData()
        {
            ...
            try
            {
                ...
                rs_new.Add(new newResourceStructure() { name = "House key - Mülverstedt (HAI)", color = "#6a8a27", description = "", duration = 1, quantity = 1, withActivity = false, resourceStructure = rs, type = "Object", explo = "Hainich-Dün" });
